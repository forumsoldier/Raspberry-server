...
// Filename: PR2224 - Copy.ggsk
// Generated fr 10. feb 14:26:49 2017
	...
	this.addSkin=function() {
		...
		this._image_1.ggUpdatePosition=function() {
			...
			if (this.parentNode) {
				...
				this.style.top=Math.floor(-133 + h) + 'px';
			}
		}
		...
		this._info.ggTextDiv.innerHTML="<span style=\"font-size: 20px;\"><font color=\"#75787b\" font face=\"Calibri\">Proportional Valve Amplifier Card - Manual Type - Converts +\/- 10VDC from Analog output modules in the plc and turns it into a 24VDC Pulse width modulated signal going to the proportional valve solenoids.<br\/><\/font><\/span>";
		this._info.appendChild(this._info__text);
		this.divSkin.appendChild(this._info);
		this._header=document.createElement('div');
		this._header__text=document.createElement('div');
		this._header.className='ggskin ggskin_textdiv';
		this._header.ggTextDiv=this._header__text;
		this._header.ggId="Header";
		this._header.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._header.ggVisible=true;
		this._header.className='ggskin ggskin_text';
		this._header.ggType='text';
		hs ='position:absolute;';
		hs+='left: 20px;';
		hs+='top:  20px;';
		hs+='width: 998px;';
		...
		hs+='padding: 0px 1px 0px 1px;';
		hs+='overflow: hidden;';
		this._header__text.setAttribute('style',hs);
		this._header.ggTextDiv.innerHTML=" <span style=\"font-size: 55px;\"><font color=\"#da291c\" font face=\"Calibri\">PR2224 - Manual Valve Controller<br\/><br\/><\/font><\/span><br\/>";
		this._header.appendChild(this._header__text);
		this.divSkin.appendChild(this._header);
